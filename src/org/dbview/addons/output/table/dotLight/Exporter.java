...
package org.dbview.addons.output.table.dotLight;
...
/**
 * @class Exporter
 * This class implements the adapter that generates the DOT specification file for the add-on that produces light DOT (GraphViz) representations.
 * @author Denis BEURIVE
 */
public class Exporter extends AbstractExporter
{
    ...
    public Object export(Database in_db, Element in_cli_conf, ArrayList<Table> in_tables) throws Exception
    {
        ...
        // Export.
        org.dbview.databaseExporters.dot.DotLight e = new org.dbview.databaseExporters.dot.DotLight(in_tables, in_db);
