...
/**
 * @class AddOnCatalogException
 * This exception is thrown whenever an error occurred while using catalogues (for add-ons).
 * @author Denis Beurive
 */
public class AddOnCatalogException extends Exception
{
    /**
     ...
     */
    public AddOnCatalogException(String in_message)
    {
        super(in_message);
    }
}
