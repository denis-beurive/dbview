 ...
 * Foreign key looks like: fk&lt;name of the target table&gt;
 * The target field is always "id".
 * @author Denis Beurive
 */
public class FkTargetTableName extends AbstractSotfForeignKeyDetector
{
    /**
    ...
    public Boolean isFk(String in_field_name)
    {
        ...
        if (in_field_name.startsWith("fk")) { return Boolean.TRUE; }
    ...
    public String description()
    {
        ...
        doc.add("Pattern:      fk{name of the target table}.");
        doc.add("Target field: Always \"id\".");
        doc.add("Example:      fkproduct_category");
