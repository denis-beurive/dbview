 ...
 * Foreign key looks like: id&lt;name of the target table&gt;
 * The target field is always "id".
 * @author Denis Beurive
 */
public class IdTargetTableName extends AbstractSotfForeignKeyDetector
{
    /**
    ...
    {
        if (in_field_name.length() < 3) { return Boolean.FALSE; }
        if (in_field_name.startsWith("id")) { return Boolean.TRUE; }
    ...
    public String referenceTable(String in_field_name)
    {
        ...
        return in_field_name.substring(2);
    }
    ...
    public String description()
    {
        ...
        doc.add("Pattern:      id{name of the target table}.");
        doc.add("Target field: Always \"id\".");
        doc.add("Example:      idproduct_category");
