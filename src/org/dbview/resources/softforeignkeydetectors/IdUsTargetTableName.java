 ...
 * Foreign key looks like: id_&lt;name of the target table&gt;
 * The target field is always "id".
 * @author Denis Beurive
 */
public class IdUsTargetTableName extends AbstractSotfForeignKeyDetector
{
    /**
    ...
    public Boolean isFk(String in_field_name)
    {
        ...
        if (in_field_name.startsWith("id_")) { return Boolean.TRUE; }
    ...
    public String description()
    {
        ...
        doc.add("Pattern:      id_{name of the target table}.");
        doc.add("Target field: Always \"id\".");
        doc.add("Example:      id_product_category");
