 ...
 * Foreign key looks like: &lt;name of the target table&gt;_id
 * The target field is always "id".
 * @author Denis Beurive
 */
public class TargetTableNameUsId extends AbstractSotfForeignKeyDetector
{
    /**
    ...
    public Boolean isFk(String in_field_name)
    {
        ...
        if (in_field_name.endsWith("_id")) { return Boolean.TRUE; }
    ...
    public String description()
    {
        ...
        doc.add("Pattern:      {name of the target table}_id.");
        doc.add("Target field: Always \"id\".");
        doc.add("Example:      product_category_id");
